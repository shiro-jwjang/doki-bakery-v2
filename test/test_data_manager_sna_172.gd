...
func test_load_resources_method_exists() -> void:
	assert_true(
		data_manager.has_method("_load_resources"),
		"DataManager should have _load_resources method"
	)
...
func test_load_resources_valid_path() -> void:
	...
	data_manager._load_resources(
		"res://resources/data/recipes/",
		"id",
		target_dict
	)
