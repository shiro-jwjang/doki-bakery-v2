...
## Test add_experience increases experience points
func test_add_experience_increases_experience() -> void:
...
## Test add_experience triggers level up at threshold (Level 1 -> 2)
...
func test_add_experience_zero() -> void:
	GameManager.add_experience(0)

	assert_eq(GameManager.get_xp(), 0, "XP should remain 0")


## Test add_experience with negative amount (should not add)
func test_add_experience_negative() -> void:
	GameManager.add_experience(50)
	GameManager.add_experience(-10)
